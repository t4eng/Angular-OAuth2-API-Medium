export const environment = {
  ...
  state: 'state',
  responseType: 'code',
  GET_TEMP_CODE: 'https://medium.com/m/oauth/authorize?client_id=704670e41f3&scope=basicProfile,listPublications&state=state&response_type=code&redirect_uri=http://127.0.0.1:4200/callback'
}